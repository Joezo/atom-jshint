...
module.exports = AtomJshint = (function(){
  ...
  AtomJsHint.prototype.updatePane = function(errors){
    ...
    errors.forEach(function(error){
      var line = 'Line: ' + error.line + ' Char:' + error.character + ' ' + error.reason;
      var link = $('<a></a>').html(line).click(function() {
          atom.workspace.getActiveEditor().cursors[0].setBufferPosition([error.line - 1, error.character - 1]);
      });
      html.append(link).append('<br/>');
    });
